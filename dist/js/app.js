(() => {
    ...
    function Navigation({swiper, extendParams, on, emit}) {
        ...
        function init() {
            ...
            const initButton = (el, dir) => {
                if (el) {
                    if (el.matches(".swiper-button-next,.swiper-button-prev") && !el.querySelector("svg")) utils_setInnerHTML(el, arrowSvg);
    ...
    function initSliders() {
        if (document.querySelector(".swiper-reviews")) new swiper_core_Swiper(".swiper-reviews", {
            ...
            speed: 800,
            pagination: {
                el: ".swiper-reviews .navigation__pagination",
                clickable: true
            },
            navigation: {
